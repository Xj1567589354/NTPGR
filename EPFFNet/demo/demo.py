...
def parse_args():
    ...
    # general
    parser.add_argument('--cfg', type=str, default=r'F:\PythonLearn\DeepLearn\hrnet-official\demo\inference-config.yaml')
...
def main():
    ...
    if args.webcam or args.video:
        ...
        if args.write:
            ...
            print('the results image has been saved as {}'.format(save_path))
