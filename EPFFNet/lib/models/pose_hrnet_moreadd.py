...
具体来说是，HRNet+多级上采样机制+各分支浅深层尺度add拼接+Non-Local
"""
...
class PoseHighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # 每个分支浅层深层尺度add
        y_list[0] = x_list1[0]+y_list2[0]+y_list3[0]+y_list[0]
        y_list[1] = y_list2[1]+y_list3[1]+y_list[1]
        y_list[2] = y_list3[2]+y_list[2]
...
def get_pose_net_moreadd(cfg, is_train, **kwargs):
