...
def parse_args():
    ...
    parser.add_argument('--image-path',
                        ...
                        type=str,
                        default='F:\PythonLearn\dataset\coco2017\images/val2017/'
                        )

    parser.add_argument('--gt-anno',
                        help='Path of COCO val annotation',
                        type=str,
                        default='F:\PythonLearn\dataset\coco2017/annotations/person_keypoints_val2017.json'
                        )

    parser.add_argument('--save-path',
                        help="Path to save the visualizations",
                        type=str,
                        default='F:\PythonLearn\DeepLearn\PSMSNet\hrnet-official/visualization/hrnet/coco/')
    ...
    for catId in catIds:
        for imgId in p.imgIds[:5000]:
            ...
            if save:
                ...
                plt.savefig(save_path +'id_'+str(imgId)+ '.jpg', format='jpg',
                            bbox_inckes='tight', dpi=400)
            # plt.show()
            plt.close()
